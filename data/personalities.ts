...
export const personalityTypes: PersonalityType[] = [
  ...
  },
  {
    slug: "anxious",
    name: "焦虑型人格",
    nameEn: "Anxious Personality",
    code: "ANXD",
    tagline: "明天的雨，今天就开始淋湿我",
    color: "#14B8A6",
    dimensions: {
      socialAnxiety: 0.9,
      sensitivity: 0.8,
    ...
    summary:
      "焦虑型人格的核心特征是对未来的过度担忧和持续的紧张感。他们的大脑像一台永远无法关机的预警雷达，时刻扫描着可能出现的威胁，身心长期处于备战状态。",
    relatedBooks: ["feeling-good", "dbt-skills", "self-compassion"],
    solutionSlug: "anxious-plan",
    iconUrl: "/images/types/anxious.svg",
  },
  {
    slug: "depressive",
    name: "抑郁型人格",
    nameEn: "Depressive Personality",
    code: "DEPD",
    tagline: "世界是灰色的，连阳光都带着重量",
    color: "#6366F1",
    dimensions: {
      socialAnxiety: 0.5,
      sensitivity: 0.7,
    ...
    summary:
      "抑郁型人格的特征是长期的悲观主义、快感缺失和自我贬低。他们的内心世界被一层灰色的滤镜覆盖，即使好事发生，也难以感受到真正的快乐和满足。",
    relatedBooks: ["feeling-good", "self-compassion", "mindfulness-ocd"],
    solutionSlug: "depressive-plan",
    iconUrl: "/images/types/depressive.svg",
  },
  {
    slug: "impulsive",
    name: "冲动型人格",
    nameEn: "Impulsive Personality",
    code: "IMPD",
    tagline: "行动永远比思考快一步",
    color: "#F43F5E",
    dimensions: {
    ...
    summary:
      "冲动型人格的特征是情绪爆发迅速、行为不计后果。他们像一辆没有刹车的赛车，在情绪的赛道上全速前进，经常在事后才意识到自己已经越过了太多边界。",
    relatedBooks: ["dbt-skills", "emotional-intelligence", "boundaries"],
    solutionSlug: "impulsive-plan",
    iconUrl: "/images/types/impulsive.svg",
  },
  {
    slug: "passive-aggressive",
    name: "被动攻击型人格",
    nameEn: "Passive-Aggressive Personality",
    code: "PAPD",
    tagline: "微笑的面具下，藏着锋利的沉默",
    color: "#84CC16",
    dimensions: {
      socialAnxiety: 0.45,
      sensitivity: 0.75,
    ...
    summary:
      "被动攻击型人格的特征是表面顺从、暗中抵抗。他们不直接表达不满，而是通过拖延、\"忘记\"、敷衍和沉默来发泄愤怒，让身边的人感到困惑和无力。",
    relatedBooks: ["boundaries", "assertiveness-workbook", "emotional-intelligence"],
    solutionSlug: "passive-aggressive-plan",
    iconUrl: "/images/types/passive-aggressive.svg",
  },
];
